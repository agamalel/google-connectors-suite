...
/**
 * GetTaskListsMessageProcessor invokes the {@link org.mule.module.google.task.GoogleTasksConnector#getTaskLists(org.mule.streaming.PagingConfiguration)} method in {@link GoogleTasksConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-02-20T04:30:03-06:00", comments = "Build UNKNOWN_BUILDNUMBER")
public class GetTaskListsMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public GetTaskListsMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final PagingConfiguration _transformedPagingConfiguration = ((PagingConfiguration) evaluateAndTransform(getMuleContext(), event, GetTaskListsMessageProcessor.class.getDeclaredField("_pagingConfigurationType").getGenericType(), null, pagingConfiguration));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleTasksConnector) object).getTaskLists(_transformedPagingConfiguration);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(TaskList.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleTasksConnector at getTaskLists retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
