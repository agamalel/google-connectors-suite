...
/**
 * DeleteTaskListMessageProcessor invokes the {@link org.mule.module.google.task.GoogleTasksConnector#deleteTaskList(java.lang.String)} method in {@link GoogleTasksConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-02-20T04:30:03-06:00", comments = "Build UNKNOWN_BUILDNUMBER")
public class DeleteTaskListMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteTaskListMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedTaskListId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteTaskListMessageProcessor.class.getDeclaredField("_taskListIdType").getGenericType(), null, taskListId));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((GoogleTasksConnector) object).deleteTaskList(_transformedTaskListId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleTasksConnector at deleteTaskList retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
