...
/**
 * A {@code GoogleTasksConnectorOAuth2Adapter} is a wrapper around {@link GoogleTasksConnector } that adds OAuth capabilites to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-02-14T11:47:49-06:00", comments = "Build UNKNOWN_BUILDNUMBER")
public class GoogleTasksConnectorOAuth2Adapter
    extends GoogleTasksConnectorProcessAdapter
    implements OAuth2Adapter, OAuth2Connector
{
    ...
    private final static Logger LOGGER = Logger.getLogger(GoogleTasksConnectorOAuth2Adapter.class);

    public GoogleTasksConnectorOAuth2Adapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
