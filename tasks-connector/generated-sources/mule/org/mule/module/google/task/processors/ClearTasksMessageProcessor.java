...
/**
 * ClearTasksMessageProcessor invokes the {@link org.mule.module.google.task.GoogleTasksConnector#clearTasks(java.lang.String)} method in {@link GoogleTasksConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-02-14T11:47:49-06:00", comments = "Build UNKNOWN_BUILDNUMBER")
public class ClearTasksMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public ClearTasksMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedTaskListId = ((String) evaluateAndTransform(getMuleContext(), event, ClearTasksMessageProcessor.class.getDeclaredField("_taskListIdType").getGenericType(), null, taskListId));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((GoogleTasksConnector) object).clearTasks(_transformedTaskListId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleTasksConnector at clearTasks retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
